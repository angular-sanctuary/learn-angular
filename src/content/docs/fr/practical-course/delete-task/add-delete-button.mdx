...
{mainTitle: 'Objectifs de ce chapitre', title: 'Supprimer une tâche', description: 'Ajoutez un bouton supprimer dans le TaskListComponent pour supprimer la tâche dans la liste.'},
]} />
...
1. Modifiez le fichier `src/app/task-list/task-list.component.html`.
   ...
   ```html ins={"1. Ajouter un bouton supprimer": 4-5}
   <ul>
...
1. Modifiez le fichier  `src/app/task-list/task-list.component.ts`.
   ...
   ```typescript ins={"Ajouter la fonction deleteTask et appeler deleteTask du TaskService": 13-16}
