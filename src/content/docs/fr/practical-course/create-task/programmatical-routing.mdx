...
description: Apprenez-en un peu plus sur le routage dans une application Angular
---

import Objective from '../../../../../components/learning-objective.astro';

<Objective class="drop-shadow-xl" objectives={[
{mainTitle: 'Objectifs de ce chapitre', title: 'Routage avancé', description: 'Apprenez à utiliser le routage avancé dans une application Angular.'},
]} />
...
Mais dans cette situation, vous allez déclencher une navigation lorsque la fonction `createTask` est appelée.
