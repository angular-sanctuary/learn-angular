...
2. Supprimez la variable `tasks` de la classe `TaskListComponent`:
...
```typescript ins={"Importez TaskService": 3-4} ins={"Créez une variable de tâches et initialisez-la avec la liste TaskService": 12-13} ins={"Injectez le TaskService dans le constructeur de la classe": 15-16}
// task-list.component.ts
