...
These options were added to the `angular.json` file when you created the project with the Angular CLI.

> This course doesn't cover testing, that's a topic for another course.

## ✔️ What you learned

We used the Angular CLI to create a new component. That's the second component you created in this project.
