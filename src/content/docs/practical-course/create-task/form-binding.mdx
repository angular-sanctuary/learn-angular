...
You will create a **task** model to represent a task. The **task** model will have two properties: **title** and **description**.
...
To update our **task** model when the form is updated, you need to use the `[(ngModel)]` format.
