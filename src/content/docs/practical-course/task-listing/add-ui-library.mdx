...
<Objective class="drop-shadow-xl" objectives={[
    {title: 'Add an UI library to your project', description: 'Learn how to add Bootstrap, an UI library, to your project to enhance the user interface of your application.'},
]} />
