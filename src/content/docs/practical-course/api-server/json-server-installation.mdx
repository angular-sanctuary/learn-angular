...
<Objective class="drop-shadow-xl" objectives={[
    {title: 'Add json-server', description: 'Install and configure json-server as a fake API server.'},
]} />

## What is json-server?

json-server is a small package that helps you to create an API with zero coding in less than 30 seconds.
It's a full fake API with zero coding that allows you to create, read, update and delete tasks.
