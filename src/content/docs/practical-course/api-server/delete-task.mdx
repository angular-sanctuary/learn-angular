---
title: Delete task with the HTTP client
description: Learn how to delete a task to a list using the HTTP client in an Angular application.
---
...
<Objective class="drop-shadow-xl" objectives={[
    {title: 'Delete a task with the HTTP client', description: 'Learn how to delete a task to a list using the HTTP client in an Angular application.'},
]} />

## The TaskService

Based on the HTTP protocol, you will use the **delete** function to add a task to the list: **http.delete()**.
This function expects only 1 parameter, the URL of the resource to delete, including once again the **id** of the task to delete.
